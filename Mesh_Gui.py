...
class MainWindow(Qt.QMainWindow):
    ...
    def next_cubes(self):
        ...
        y_c2_V, y_c2_F = self.create_cube(y2[2][y2[1],:], face_center[4], 'y')
        z_c1_V, z_c1_F = self.create_cube(z1[2][z1[1],:], face_center[0], 'z')
        z_c2_V, z_c2_F = self.create_cube(z2[2][z2[1],:], face_center[5], 'z')
